...
song2_isPlaying = song2.isPlaying()
...
song1.stop();
if(song2_isPlaying = false){
   song2.play() ;
   document.getElementById("song_name").innerHTML = "You Say Run!";
}
}
}
...
console.log("Right Wrist Score: "+scoreRight);
